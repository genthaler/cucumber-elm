...
var _user$project$Stack$pop = function (stack) {
	var _p0 = stack;
	if (_p0.ctor === '::') {
		return {
			ctor: '_Tuple2',
...
var _user$project$Stack$stackIterator = function (stack) {
	return _elm_community$lazy_list$Lazy_List$flatten(
		A2(
			_elm_community$lazy_list$Lazy_List$map,
			function (_p1) {
				return A2(
					...
					_elm_community$lazy_list$Lazy_List$empty,
					A2(_elm_lang$core$Maybe$map, _elm_community$lazy_list$Lazy_List$singleton, _p1));
			},
			A2(
				...
				A2(
					...
					A2(
						...
						function (_p2) {
							var _p3 = _p2;
							return _user$project$Stack$pop(_p3._1);
						},
						_user$project$Stack$pop(stack))))));
};
var _user$project$Stack$push = F2(
	function (tok, stack) {
		return {ctor: '::', _0: tok, _1: stack};
	});

var _user$project$Calc$input = _elm_lang$core$Native_Platform.incomingPort('input', _elm_lang$core$Json_Decode$string);
var _user$project$Calc$output = _elm_lang$core$Native_Platform.outgoingPort(
	'output',
	function (v) {
		return v;
	});
var _user$project$Calc$close = _elm_lang$core$Native_Platform.incomingPort(
	'close',
	_elm_lang$core$Json_Decode$succeed(
		{}));
var _user$project$Calc$end = _elm_lang$core$Native_Platform.outgoingPort(
	'end',
	function (v) {
		return v;
	});
var _user$project$Calc$update = F2(
	function (action, model) {
		var doBin = function (action) {
			var _p0 = action;
			switch (_p0.ctor) {
				case 'Add':
					return F2(
		...
		var updatedModel = function () {
			var doBinary = function () {
				var _p1 = _user$project$Stack$pop(model);
				var aa = _p1._0;
				var m1 = _p1._1;
				var _p2 = _user$project$Stack$pop(m1);
				var bb = _p2._0;
				var m2 = _p2._1;
				var _p3 = {ctor: '_Tuple2', _0: aa, _1: bb};
				if (((_p3.ctor === '_Tuple2') && (_p3._0.ctor === 'Just')) && (_p3._1.ctor === 'Just')) {
					return A2(
						_user$project$Stack$push,
						A3(doBin, action, _p3._0._0, _p3._1._0),
						m2);
				} else {
					return model;
				}
			...
			switch (_p4.ctor) {
				...
				case 'Div':
					return doBinary;
				case 'Val':
					return A2(_user$project$Stack$push, _p4._0, model);
				default:
					return model;
			}
		}();
		return {
			...
			_1: function () {
				var _p5 = {
					ctor: '_Tuple2',
					_0: action,
					_1: _user$project$Stack$pop(updatedModel)
				};
				if (_p5._1._0.ctor === 'Nothing') {
					if (_p5._0.ctor === 'Close') {
						return _user$project$Calc$end(1);
					} else {
						return _user$project$Calc$output('Nothing');
					}
				} else {
					if (_p5._0.ctor === 'Close') {
						return _elm_lang$core$Platform_Cmd$batch(
							{
								ctor: '::',
								_0: _user$project$Calc$output(
									_elm_lang$core$Basics$toString(_p5._1._0._0)),
								_1: {
									ctor: '::',
									_0: _user$project$Calc$end(0),
									_1: {ctor: '[]'}
								}
							});
					} else {
						return _user$project$Calc$output(
							A2(
								...
								_elm_community$lazy_list$Lazy_List$toList(
									A2(
										...
										_user$project$Stack$stackIterator(updatedModel)))));
					}
				}
			}()
		};
	});
var _user$project$Calc$Close = {ctor: 'Close'};
var _user$project$Calc$Val = function (a) {
	return {ctor: 'Val', _0: a};
};
var _user$project$Calc$Div = {ctor: 'Div'};
var _user$project$Calc$Mul = {ctor: 'Mul'};
var _user$project$Calc$Sub = {ctor: 'Sub'};
var _user$project$Calc$Add = {ctor: 'Add'};
var _user$project$Calc$NoOp = {ctor: 'NoOp'};
var _user$project$Calc$translateInputString = function (str) {
	var _p6 = str;
	switch (_p6) {
		case '+':
			return _user$project$Calc$Add;
		case '-':
			return _user$project$Calc$Sub;
		case '*':
			return _user$project$Calc$Mul;
		case '/':
			return _user$project$Calc$Div;
		default:
			var _p7 = _elm_lang$core$String$toFloat(str);
			if (_p7.ctor === 'Ok') {
				return _user$project$Calc$Val(_p7._0);
			} else {
				return _user$project$Calc$NoOp;
			}
	}
};
var _user$project$Calc$main = _elm_lang$core$Platform$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: {ctor: '[]'},
		...
		update: _user$project$Calc$update,
		subscriptions: function (_p8) {
			return _elm_lang$core$Platform_Sub$batch(
				{
					ctor: '::',
					_0: _user$project$Calc$input(_user$project$Calc$translateInputString),
					_1: {
						ctor: '::',
						_0: _user$project$Calc$close(
							function (_p9) {
								return _user$project$Calc$Close;
							}),
						_1: {ctor: '[]'}
					}
				});
